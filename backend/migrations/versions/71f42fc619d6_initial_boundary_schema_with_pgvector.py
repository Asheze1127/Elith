...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_citation_chunk_id'), 'citation', ['chunk_id'], unique=False)
    op.create_index(op.f('ix_citation_document_id'), 'citation', ['document_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_citation_document_id'), table_name='citation')
    op.drop_index(op.f('ix_citation_chunk_id'), table_name='citation')
